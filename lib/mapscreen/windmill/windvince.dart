...
class Windplay extends StatefulWidget {
  const Windplay({Key? key}) : super(key: key);

  @override
  State<Windplay> createState() => _WindplayState();
}

class _WindplayState extends State<Windplay> {
  @override
  void initState() {
    super.initState();

    FlameAudio.bgm.play('windmill.mp3');
  }
