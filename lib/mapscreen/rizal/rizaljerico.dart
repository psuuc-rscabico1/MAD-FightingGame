...
class RizalPlay3 extends StatefulWidget {
  const RizalPlay3({Key? key}) : super(key: key);

  @override
  State<RizalPlay3> createState() => _RizalPlay3State();
}

class _RizalPlay3State extends State<RizalPlay3> {
  @override
  void initState() {
    super.initState();

    FlameAudio.bgm.play('rizal.mp3');
  }
