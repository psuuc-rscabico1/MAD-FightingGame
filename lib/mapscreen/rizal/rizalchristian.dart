...
class RizalPlay2 extends StatefulWidget {
  const RizalPlay2({Key? key}) : super(key: key);

  @override
  State<RizalPlay2> createState() => _RizalPlay2State();
}

class _RizalPlay2State extends State<RizalPlay2> {
  @override
  void initState() {
    super.initState();
