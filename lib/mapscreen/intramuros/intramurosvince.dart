...
class Intramuros1 extends StatefulWidget {
  const Intramuros1({Key? key}) : super(key: key);

  @override
  State<Intramuros1> createState() => _Intramuros1State();
}

class _Intramuros1State extends State<Intramuros1> {
  @override
  void initState() {
    super.initState();
                        ...
                        (skill) => Padding(
                          ...
                          child: ElevatedButton(
                            ...
                            child: Ink(
                              decoration: BoxDecoration(
                                image: DecorationImage(
                                  image: AssetImage('assets/images/brick-wall.jpg'), // Replace with your image path
                              ...
                              child: Container(
                                ...
                                child: Text(
                                  skill,
                                  style: TextStyle(fontSize: 12.5, color: Colors.white, fontWeight: FontWeight.w700 ),
