...
class IntramurosPlay3 extends StatefulWidget {
  const IntramurosPlay3({Key? key}) : super(key: key);

  @override
  State<IntramurosPlay3> createState() => _IntramurosPlay3State();
}

class _IntramurosPlay3State extends State<IntramurosPlay3> {
  @override
  void initState() {
    super.initState();

    FlameAudio.bgm.play('intramuros.mp3');
  }
                                  ...
                                  child: Row(
                                    children: [
                                      Padding(
                                        padding: EdgeInsets.all(8.0),
                                        child: Image.asset(
                                          'assets/images/jericostanding.gif',
                                          width: 30,
                                          height: 30,
                                        ),
                                      ),
                                      Text('Buhay: $enemyHealth / 150'),
                                    ],
                                  ),
                                ),
                              ),
                        ...
                        (skill) => Padding(
                          ...
                          child: ElevatedButton(
                                ...
                                ? () async {
                                    ...
                                    if (enemyHealth == 0) {
                                      ...
                                      final selectedSkillIndex =
                                          random.nextInt(echoskills.length);

                                      final selectedSkill =
                                          echoskills[selectedSkillIndex];
                                      enemyindexskill =
                                    ...
                                    if (health <= 0) {
                                      ...
                                      setState(() {
                                        sulat =
                                            'Si Jerico ay gumamit ng ${selectedSkill['name']}';
                                      });
                                      indexskill = 5;
                            ...
                            child: Ink(
                              decoration: BoxDecoration(
                                image: DecorationImage(
                                  image: AssetImage('assets/images/brick-wall.jpg'), 
                                  fit: BoxFit.cover, 
                                ),
                                borderRadius: BorderRadius.circular(10), 
                              ),
