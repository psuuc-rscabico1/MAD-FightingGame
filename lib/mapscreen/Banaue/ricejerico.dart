...
class Riceplay3 extends StatefulWidget {
  const Riceplay3({Key? key}) : super(key: key);

  @override
  State<Riceplay3> createState() => _Riceplay3State();
}

class _Riceplay3State extends State<Riceplay3> {
  @override
  void initState() {
    super.initState();
