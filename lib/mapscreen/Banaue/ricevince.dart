...
class RicePlay1 extends StatefulWidget {
  const RicePlay1({Key? key}) : super(key: key);

  @override
  State<RicePlay1> createState() => _RicePlay1State();
}

class _RicePlay1State extends State<RicePlay1> {
  @override
  void initState() {
    super.initState();
