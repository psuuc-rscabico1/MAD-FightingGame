...
class BoracayPlay3 extends StatefulWidget {
  const BoracayPlay3({Key? key}) : super(key: key);

  @override
  State<BoracayPlay3> createState() => _BoracayPlay3State();
}

class _BoracayPlay3State extends State<BoracayPlay3> {
  @override
  void initState() {
    super.initState();

    FlameAudio.bgm.play('boracay.mp3');
  }
