...
class Mayonplay3 extends StatefulWidget {
  const Mayonplay3({Key? key}) : super(key: key);

  @override
  State<Mayonplay3> createState() => _Mayonplay3State();
}

class _Mayonplay3State extends State<Mayonplay3> {
  @override
  void initState() {
    super.initState();

    FlameAudio.bgm.play('mayon.mp3');
  }
